...
% Order of classes, whole feature set, all rpm, placement on bearing A
	% Severity is rising sequentially, each group is shuffled randomly, validation set is kept away for hold-valiadtion.
	% (Progressive valuation with 20\% of dataset kept away for additional hold-out validation):
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Training set and defect types ``fault'' as predicted variable}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{assets/design/Online-event-ordering-anomaly60-train.png}
        \caption{Training set and anomaly with severity above 0.6 ``anomaly60'' as predicted variable}
    \end{subfigure}
...
% Gradual learning with delay - label provided after it has been predicted by the model
	% The amount to wait before revealing the target associated with each observation to the model.
	
\begin{figure}[ht]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{assets/design/gradual-learning-accuracy-delay-temporal-domain-fault.png}
        \caption{Temporal domain features, predicted variable is fault}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{assets/design/gradual-learning-accuracy-delay-spectral-domain-fault.png}
        \caption{Spectral domain features, predicted variable is fault}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{assets/design/gradual-learning-accuracy-delay-temporal-domain-anomaly60.png}
        \caption{Temporal domain features, predicted variable is anomaly above severity 0.6}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \includegraphics[width=\textwidth]{assets/design/gradual-learning-accuracy-delay-spectral-domain-anomaly60.png}
        \caption{Spectral domain features, predicted variable is anomaly above severity 0.6}
    \end{subfigure}
    \caption{Incremental learning on all extracted features with delayed reveal of labels in rolling window}
\end{figure}
	
	

% Window learning- all labels for fixed previous period are provided at once.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Spectral domain features}
    \end{subfigure}
    \caption{Incremental learning for variable ``fault'' with delayed reveal of labels at regular intervals.}
\end{figure}


% Missing labels - some labels are skipped before another one is anotated
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \caption{Spectral domain features}
    \end{subfigure}
    \caption{Incremental learning with skipping of labels and delay of 10 observations}
\end{figure}

% Scatter plot of fault classification - min-max scale shifts. From left true labels, predicted labels, mistakes made by model in red  
