...
The orbital plot of the first harmonic frequency $f_{max}$ in Figure~\ref{fig:design:orbital-analysis} allows us to check the sensor deviation out of the axis of rotation. The Butterworth filter of \nth{5} order with cutoff frequencies $f_{max} \pm 5\;\mathrm{Hz}$ is applied in its filtering.
