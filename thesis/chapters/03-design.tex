...
% Describe preliminary measurements, waveform (1) orbital (2), velocity (3)
...
% Velocity: integrated with composite trapezoidal rule and subtracted mean of envelope found by cubic interpolation of peaks.

% bandpass Butterworth filter of \nth{5} order with cuttoff frequencies f_{max} \pm 5 Hz.
...
% Historical logs of pump from KSB cloud
