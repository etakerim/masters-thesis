...
\newcommand{\ThesisTitle}[0] {Priebežná správa o riešení DP1}
\newcommand{\ThesisTitleEN}[0] {Progress report in Master's thesis project I}
...
\newcommand{\Date}[0] {Jún 2023}
\newcommand{\DateEN}[0] {June 2023}
...
\newcommand{\SignDateEN}[0] {June 2023}
...
\input{chapters/02-analysis-A-CdM}
\input{chapters/02-analysis-B-features}
\input{chapters/02-analysis-C-diagnostics}
\input{chapters/02-analysis-D-datasets}
...
\input{chapters/appendix/B-plan-of-work}
