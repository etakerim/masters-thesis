...
% Thesis topic
\thispagestyle{empty}
\includepdf[pages=-, scale=0.9]{chapters/preliminaries/topic}
\emptypage
...
\nomenclature{\textbf{k-NN}}{k-nearest neighbours algorithm}
\nomenclature{\textbf{kSpS}}{kilo-samples per second}
...
\input{chapters/appendix/A-technical-documentation}

\input{chapters/appendix/B-user-guide}

\input{chapters/appendix/C-iit-src-paper}

\input{chapters/appendix/D-work-plan}

\input{chapters/appendix/E-digital-medium}
